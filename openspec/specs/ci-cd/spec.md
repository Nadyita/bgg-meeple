...
Pushing any tag starting with `v` SHALL trigger a release workflow that builds release artifacts and attaches them to the created GitHub Release automatically.
