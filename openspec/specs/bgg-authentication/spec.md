# bgg-authentication Specification

## Purpose

Defines how the app stores BGG credentials and API tokens securely, logs into BoardGameGeek to obtain a session, and reuses or refreshes that session for authenticated API calls.
