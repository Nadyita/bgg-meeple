...
class DriftCollectionStore implements CollectionStore {
  ...
  drift.CollectionItemsCompanion _toCollectionCompanion(
    ...
    return drift.CollectionItemsCompanion(
      ...
      inventoryLocation: Value(item.inventoryLocation),
      bestPlayerCount: Value(item.bestPlayerCount),
      bestPlayerCountMin: Value(item.bestPlayerCountMin),
      bestPlayerCountMax: Value(item.bestPlayerCountMax),
      recommendedPlayerCount: Value(item.recommendedPlayerCount),
      recommendedPlayerCountMin: Value(item.recommendedPlayerCountMin),
      recommendedPlayerCountMax: Value(item.recommendedPlayerCountMax),
      suggestedPlayerAge: Value(item.suggestedPlayerAge),
