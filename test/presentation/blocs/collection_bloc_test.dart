...
void main() {
  ...
  group('CollectionBloc', () {
    ...
    blocTest<CollectionBloc, CollectionState>(
      'filters by recommended player count range and falls back to publisher',
      build: () {
        when(loadCollection.call).thenAnswer(
          (_) async => const [
            CollectionItem(
            ...
            CollectionItem(
              ...
              minPlayers: 1,
              maxPlayers: 4,
              recommendedPlayerCountMin: 1,
              recommendedPlayerCountMax: 2,
            ),
            CollectionItem(
              thingId: 4,
              names: [],
              minPlayers: 1,
              maxPlayers: 8,
              recommendedPlayerCountMin: null,
              recommendedPlayerCountMax: null,
            ),
          ],
        );
        return _buildBloc(
      ...
      expect: () => [
        predicate<CollectionState>(
          (s) =>
              s.filteredItems.length == 3 &&
              s.filteredItems.every(
                (i) => i.thingId == 1 || i.thingId == 2 || i.thingId == 4,
              ),
        ),
      ],
    );
    ...
    blocTest<CollectionBloc, CollectionState>(
      'filters by best player count range with fallback to recommended and publisher',
      build: () {
        when(loadCollection.call).thenAnswer(
          (_) async => const [
            CollectionItem(
            ...
            CollectionItem(
              ...
              minPlayers: 2,
              maxPlayers: 8,
              bestPlayerCountMin: null,
              bestPlayerCountMax: null,
              recommendedPlayerCountMin: 3,
              recommendedPlayerCountMax: 4,
            ),
            CollectionItem(
      ...
      expect: () => [
        predicate<CollectionState>(
          (s) =>
              s.filteredItems.length == 3 &&
              s.filteredItems.every(
                (i) => i.thingId == 1 || i.thingId == 2 || i.thingId == 3,
              ),
        ),
      ],
    );
    ...
    blocTest<CollectionBloc, CollectionState>(
      'clears player count slider but keeps selected mode',
      build: () {
        when(loadCollection.call).thenAnswer(
          (_) async => const [
            CollectionItem(
      ...
      expect: () => [
        predicate<CollectionState>(
          (s) =>
              s.filter.minPlayers == null &&
              s.filter.maxPlayers == null &&
              s.filter.playerCountFilterMode ==
